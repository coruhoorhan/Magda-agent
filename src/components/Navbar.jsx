...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur-md dark:bg-gray-900/80 border-b dark:border-gray-800 p-4 transition-colors">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="font-bold text-xl text-rose-500 dark:text-rose-400">AirbnbFatsa</div>
