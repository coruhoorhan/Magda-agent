...
from magda_agent.integration.a2a_circuit_breaker_v7 import (
    A2ADelegationCircuitBreakerV7,
    CircuitState,
...
async def test_circuit_breaker_normal_execution() -> None:
    ...
    """
    breaker = A2ADelegationCircuitBreakerV7(failure_threshold=2, recovery_timeout=0.1, success_threshold=2)
    peer_id = "peer-1"
...
async def test_circuit_breaker_trips_on_failures() -> None:
    ...
    """
    breaker = A2ADelegationCircuitBreakerV7(failure_threshold=2, recovery_timeout=1.0, success_threshold=2)
    peer_id = "peer-1"
...
async def test_circuit_breaker_recovery_to_half_open_and_close() -> None:
    ...
    """
    breaker = A2ADelegationCircuitBreakerV7(failure_threshold=1, recovery_timeout=0.1, success_threshold=2)
    peer_id = "peer-1"
...
async def test_circuit_breaker_peer_isolation() -> None:
    ...
    """
    breaker = A2ADelegationCircuitBreakerV7(failure_threshold=1, recovery_timeout=1.0)
    peer_a = "peer-A"
    peer_b = "peer-B"
