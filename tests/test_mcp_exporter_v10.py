...
from magda_agent.integration.mcp_exporter_v10 import MCPExporterV10
...
@pytest.fixture
def exporter(registry: SkillRegistry) -> MCPExporterV10:
    """Creates an MCPExporterV10 fixture."""
    return MCPExporterV10(registry)

def test_export_tools(exporter: MCPExporterV10) -> None:
...
def test_validate_schema_success(exporter: MCPExporterV10) -> None:
...
def test_validate_schema_missing_required(exporter: MCPExporterV10) -> None:
...
def test_validate_schema_invalid_type(exporter: MCPExporterV10) -> None:
...
@pytest.mark.asyncio
async def test_handle_rpc_request_success(exporter: MCPExporterV10) -> None:
...
@pytest.mark.asyncio
async def test_handle_rpc_request_invalid_method(exporter: MCPExporterV10) -> None:
...
@pytest.mark.asyncio
async def test_handle_rpc_request_invalid_jsonrpc(exporter: MCPExporterV10) -> None:
...
@pytest.mark.asyncio
async def test_handle_rpc_request_invalid_params(exporter: MCPExporterV10) -> None:
